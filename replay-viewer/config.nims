...
switch(
  "passL",
  (&"""
  -o {distDir / "gozu_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=GozuReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_gzu_load_replay,_gzu_payload_ptr,_gzu_payload_len,_gzu_error_ptr,_gzu_error_len
  """).replace("\n", " ")
)
